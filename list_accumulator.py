def main(args: list[str]) -> int:
    ...
    list_string = input('Please enter a list of one or more numbers, separated by commas: ')
    #print(list_string)
    ...
    length = 0 # Accumulator variable for length of list
    total = 0 # Accumulator variable for sum
    product = 1 # Accumulator variable for product
